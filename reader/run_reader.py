...
class Reader(BaseReader):
    def __init__(self, line_rec=True,
        ...
        if self.line_rec:
            self.rec_model = CustomPaddleRec(model_name='paddleocr_v4_hand', version=2, batch_size=20)
        else:
            self.rec_model = PaddleRec(model_name='paddleocr_v4_hand', version=2, batch_size=20)
